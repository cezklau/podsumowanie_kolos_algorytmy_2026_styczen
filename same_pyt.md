...
13. Wymień operacje na strukturach dynamicznych i do czego służą:
14. Co to lista z dowiązaniem (linked list)?
15. Co to lista dwukierunkowa?
16. Czy listy i tablice w Pythonie to struktury, o których tutaj mowa?

## Rzędy wielkości funkcji
1. Co to rząd wielkości funkcji?
2. Jakie są notacje asymptotyczne i czym się różnią?
3. Co to asymptotycznie niedokładne ograniczenie górne? (o)
4. Co to asymptotycznie niedokładne ograniczenie dolne? (ω)
5. Jakie są standardowe rzędy wielkości funkcji?
